...
class Sale(wx.Frame):
    ...
    def setup_gui(self):
        ...
        if not self.editable:
            ...
            self.textbox_delivery_telephone.SetBackgroundColour(core.default_disabled_color)
            self.textbox_delivery_city.SetBackgroundColour(core.default_disabled_color)
            self.textbox_delivery_date.SetBackgroundColour(core.default_disabled_color)
            self.textbox_delivery_hour.SetBackgroundColour(core.default_disabled_color)
            self.textbox_delivery_receiver.SetWindowStyle(wx.TE_READONLY)
            self.textbox_delivery_address.SetWindowStyle(wx.TE_READONLY)
            self.textbox_delivery_telephone.SetWindowStyle(wx.TE_READONLY)
            self.textbox_delivery_city.SetWindowStyle(wx.TE_READONLY)
            self.textbox_delivery_date.SetWindowStyle(wx.TE_READONLY)
            self.textbox_delivery_hour.SetWindowStyle(wx.TE_READONLY)
    ...
    def setup_delivery(self, event):
        ...
        if self.delivery.GetValue():
            self.textbox_delivery_receiver.Unbind(wx.EVT_CHAR)
            self.textbox_delivery_receiver.Bind(wx.EVT_CHAR, core.all_char)
            self.textbox_delivery_receiver.SetBackgroundColour(wx.NullColour)
            self.textbox_delivery_receiver.ClearBackground()
            self.textbox_delivery_address.Unbind(wx.EVT_CHAR)
            self.textbox_delivery_address.Bind(wx.EVT_CHAR, core.all_char)
            self.textbox_delivery_address.SetBackgroundColour(wx.NullColour)
            self.textbox_delivery_address.ClearBackground()
            self.textbox_delivery_telephone.Unbind(wx.EVT_CHAR)
            self.textbox_delivery_telephone.Bind(wx.EVT_CHAR, core.all_char)
            self.textbox_delivery_telephone.SetBackgroundColour(wx.NullColour)
            self.textbox_delivery_telephone.Bind(wx.EVT_CHAR, core.check_telephone)
            self.textbox_delivery_telephone.ClearBackground()
            self.textbox_delivery_city.Unbind(wx.EVT_CHAR)
            self.textbox_delivery_city.Bind(wx.EVT_CHAR, core.all_char)
            self.textbox_delivery_city.SetBackgroundColour(wx.NullColour)
            self.textbox_delivery_city.SetValue(u"Itatiba")
            self.textbox_delivery_city.ClearBackground()
            self.textbox_delivery_date.Unbind(wx.EVT_CHAR)
            self.textbox_delivery_date.Bind(wx.EVT_CHAR, core.check_date)
            self.textbox_delivery_date.SetBackgroundColour(wx.NullColour)
            a = str(datetime.now().month)
            if len(a) == 1:
                a = '0' + a
            self.textbox_delivery_date.SetValue(core.good_show("date", ("%s/%s" % (datetime.now().day, a))))
            self.textbox_delivery_date.ClearBackground()
            self.textbox_delivery_hour.Unbind(wx.EVT_CHAR)
            self.textbox_delivery_hour.Bind(wx.EVT_CHAR, core.hour_check)
            self.textbox_delivery_hour.SetBackgroundColour(wx.NullColour)
            self.textbox_delivery_hour.SetValue("00:00")
            self.textbox_delivery_hour.ClearBackground()

        else:
            self.textbox_delivery_receiver.Bind(wx.EVT_CHAR, core.no_char)
            self.textbox_delivery_receiver.Clear()
            self.textbox_delivery_receiver.SetBackgroundColour("#C0C0C0")
            self.textbox_delivery_address.Bind(wx.EVT_CHAR, core.no_char)
            self.textbox_delivery_address.Clear()
            self.textbox_delivery_address.SetBackgroundColour("#C0C0C0")
            self.textbox_delivery_address.ClearBackground()
            self.textbox_delivery_telephone.Bind(wx.EVT_CHAR, core.no_char)
            self.textbox_delivery_telephone.Clear()
            self.textbox_delivery_telephone.SetBackgroundColour("#C0C0C0")
            self.textbox_delivery_telephone.ClearBackground()
            self.textbox_delivery_city.Bind(wx.EVT_CHAR, core.no_char)
            self.textbox_delivery_city.Clear()
            self.textbox_delivery_city.SetBackgroundColour("#C0C0C0")
            self.textbox_delivery_city.ClearBackground()
            self.textbox_delivery_date.Bind(wx.EVT_CHAR, core.no_char)
            self.textbox_delivery_date.Clear()
            self.textbox_delivery_date.SetBackgroundColour("#C0C0C0")
            self.textbox_delivery_date.ClearBackground()
            self.textbox_delivery_hour.Bind(wx.EVT_CHAR, core.no_char)
            self.textbox_delivery_hour.Clear()
            self.textbox_delivery_hour.SetBackgroundColour("#C0C0C0")
            self.textbox_delivery_hour.ClearBackground()
